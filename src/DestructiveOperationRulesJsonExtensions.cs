...
/// <summary>
/// Provides JSON serialization helpers for <see cref="DestructiveOperationRules"/> lint rules.
/// </summary>
public static class DestructiveOperationRulesJsonExtensions
{
    ...
    /// <summary>
    /// Serializes the collection of destructive operation lint rules to a JSON string.
    /// </summary>
    /// <param name="value">The collection of lint rules to serialize.</param>
    /// <param name="indented">Whether to format the JSON with indentation for readability.</param>
    /// <returns>A JSON string representing the lint rules collection.</returns>
